...
for i = 1:numOfPointSets
    ...
    plot([pointSets(1,56,i) pointSets(1,1,i)],[pointSets(2,56,i) pointSets(2,1,i)],'LineWidth', 1, 'Color', [rand rand rand], 'Parent', ax);
end
...
for i = 1:numOfPointSets
   ...
   plot([preshapePoints(1,56,i) preshapePoints(1,1,i)],[preshapePoints(2,56,i) preshapePoints(2,1,i)],'LineWidth', 1, 'Color', [rand rand rand], 'Parent', ax1);
end
plot(mean(1,:),mean(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',ax1);
plot([mean(1,56) mean(1,1)],[mean(2,56) mean(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', ax1);
...
cov_matrix = zeros(112, 112);
for i = 1:numOfPointSets
    var = preshapePoints(:,:,i) - mean;
    var = reshape(var,[112 1]);
...
eig_vec1 = reshape(V(:,112),[2,56]);

f2 = figure();
p1 = subplot(1,3,1);
hold on;
axis equal;
var1 = mean - 3*sqrt(eig_values(112))*eig_vec1(1,:);
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p1);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p1);
...
plot([mean(1,56) mean(1,1)],[mean(2,56) mean(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p2);
title('Mean hand using code 11', 'Parent', p2);
xlim(xrange);
ylim(yrange);
hold off;
p3 = subplot(1,3,3);
hold on;
axis equal;
var2 = mean + 3*sqrt(eig_values(111))*eig_vec1(1,:);
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p3);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p3);
title('3 standard deviations ahead on largest mode of variation','Parent',p3);
xlim(xrange);
ylim(yrange);
hold off;
f3 = figure();
eig_vec2 = reshape(V(:,111),[2,56]);
p11 = subplot(1,3,1);
hold on;
axis equal;
var1 = mean - 3*sqrt(eig_values(111))*eig_vec2;
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p11);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p11);
...
plot([mean(1,56) mean(1,1)],[mean(2,56) mean(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p12);
title('Mean hand using code 11', 'Parent', p12);
xlim(xrange);
ylim(yrange);
hold off;
p13 = subplot(1,3,3);
hold on;
axis equal;
var2 = mean + 3*sqrt(eig_values(111))*eig_vec2;
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p13);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p13);
title('3 standard deviations ahead on second largest mode of variation','Parent',p13);
xlim(xrange);
ylim(yrange);
hold off;
f4 = figure();
eig_vec3 = reshape(V(:,110),[2,56]);
p21 = subplot(1,3,1);
hold on;
axis equal;
var1 = mean - 3*sqrt(eig_values(110))*eig_vec3;
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p21);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p21);
...
plot([mean(1,56) mean(1,1)],[mean(2,56) mean(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p22);
title('Mean hand using code 11', 'Parent', p22);
xlim(xrange);
ylim(yrange);
hold off;
p23 = subplot(1,3,3);
hold on;
var2 = mean + 3*sqrt(eig_values(110))*eig_vec3;
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
axis equal;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p23);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p23);
xlim(xrange);
ylim(yrange);
title('3 standard deviations ahead on third largest mode of variation','Parent',p23);
hold off;
f5 = figure();
tom = linspace(1,112,112);
plot(tom,eig_values(112:-1:1));
title('Eigenvalues');
...
plot([mean1(1,56) mean1(1,1)],[mean1(2,56) mean1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', ax11);
...
hold on;
axis equal;
var1 = mean1 - 3*sqrt(eig_values(112))*eig_vec1;
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p31);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p31);
title('3 standard deviations behind on largest mode of variation','Parent',p1);
hold off;
p32 = subplot(1,3,2);
hold on;
...
plot([mean1(1,56) mean1(1,1)],[mean1(2,56) mean1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p32);
title('Mean hand using code 22', 'Parent', p32);
hold off;
p33 = subplot(1,3,3);
hold on;
axis equal;
var2 = mean1 + 3*sqrt(eig_values(112))*eig_vec1;
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p33);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p33);
...
hold on;
axis equal;
var1 = mean1 - 3*sqrt(eig_values(111))*eig_vec2;
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p41);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p41);
...
plot([mean1(1,56) mean1(1,1)],[mean1(2,56) mean1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p42);
title('Mean hand using code 22', 'Parent', p42);
hold off;
p43 = subplot(1,3,3);
hold on;
axis equal;
var2 = mean1 + 3*sqrt(eig_values(111))*eig_vec2;
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p43);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p43);
...
hold on;
axis equal;
var1 = mean1 - 3*sqrt(eig_values(110))*eig_vec3;
norm = sqrt(sum(sum(var1.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var1 = var1./norms;
plot(var1(1,:),var1(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p51);
plot([var1(1,56) var1(1,1)],[var1(2,56) var1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p51);
...
plot([mean1(1,56) mean1(1,1)],[mean1(2,56) mean1(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p52);
title('Mean hand using code 22', 'Parent', p52);
hold off;
p53 = subplot(1,3,3);
hold on;
var2 = mean1 + 3*sqrt(eig_values(110))*eig_vec3;
norm = sqrt(sum(sum(var2.^2, 2), 1));
norms = repmat(norm, 2, 56, 1);
var2 = var2./norms;
axis equal;
plot(var2(1,:),var2(2,:),'LineWidth',4,'Color',[0 0 0],'Parent',p53);
plot([var2(1,56) var2(1,1)],[var2(2,56) var2(2,1)],'LineWidth', 4, 'Color', [0 0 0], 'Parent', p53);
